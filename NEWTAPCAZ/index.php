		...
		<div class="container">
			...
			<nav>
				<ul>
					...
					<li><a href="./TAPCAZ.design" class="current">TAPCAZ</a></li>
					<li><a href="./BLAGUES.design">BLAGUES</a></li>
					<li><a href="./BUTTOn_TESTS.design">BUTTON TESTS</a></li>
				</ul>
			</nav>
		</div>
	</header>
...
<!--RIGHT BLOCK-->
	...
	<div id="pseudoForm" hidden>
		<form method="POST" action="https://www.youtube.com/">
			Bien joué !<br/>Rentre ton pseudo pour<br/>apparaître dans les HighScores !<br/><br/>
